        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          >
            ...
            <p className="text-gray-400 text-sm">
              Bringing amazing content and entertainment to your doorstep since 2024.
            </p>
          ...
          >
            ...
            <ul className="space-y-2">
              {services.map((service) => (
                <li key={service}>
                  <a className="text-gray-400 hover:text-white transition-colors duration-300 flex items-center gap-2">
                    <span className="text-xs">→</span>
                    {service}
                  </a>
                </li>
          ...
          >
            ...
            <div className="flex flex-col space-y-2">
              ...
              />
              <button className="px-4 py-2 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-lg hover:from-blue-600 hover:to-indigo-600 transition-all duration-300">
                Subscribe
              </button>
            </div>
          </motion.div>
...
const services = ["Content Creation", "Digital Marketing", "Brand Development", "Social Media"];
